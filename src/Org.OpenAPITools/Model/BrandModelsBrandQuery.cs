...
namespace Org.OpenAPITools.Model
{
    ...
    /// A brand query.
    /// </summary>
    [DataContract(Name = "Brand.Models.BrandQuery")]
    public partial class BrandModelsBrandQuery : IEquatable<BrandModelsBrandQuery>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandModelsBrandQuery" /> class.
        /// </summary>
        /// <param name="createdAfter">Limits query to brands created after the specified date..</param>
        /// <param name="brandIds">Limits query to only include the supplied brand ids..</param>
        /// <param name="externalIds">Limits query to externalIds.</param>
        public BrandModelsBrandQuery(DateTime createdAfter = default(DateTime), List<int> brandIds = default(List<int>), List<string> externalIds = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Limits query to brands created after the specified date.</value>
        ...
        /// </summary>
        /// <value>Limits query to only include the supplied brand ids.</value>
        ...
        {
            return this.Equals(input as BrandModelsBrandQuery);
        }

        /// <summary>
        /// Returns true if BrandModelsBrandQuery instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandModelsBrandQuery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandModelsBrandQuery input)
        {
            if (input == null)
            {
                return false;
