...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User.Models.Read.UserProfile")]
    public partial class UserModelsReadUserProfile : IEquatable<UserModelsReadUserProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserModelsReadUserProfile" /> class.
        /// </summary>
        ...
        public UserModelsReadUserProfile(int userId = default(int), int siteId = default(int), string email = default(string), string firstName = default(string), string lastName = default(string), string phoneNr = default(string), string mobilePhoneNr = default(string), string company = default(string), string address = default(string), string address2 = default(string), string address3 = default(string), string doorCode = default(string), string personalId = default(string), string birthyear = default(string), string zip = default(string), string city = default(string), string careOf = default(string), string country = default(string), int memberId = default(int), string memberType = default(string), int countryId = default(int), int userTypeId = default(int), bool gender = default(bool), bool newsletter = default(bool))
        {
            this.UserId = userId;
            this.SiteId = siteId;
            this.Email = email;
        ...
        {
            return this.Equals(input as UserModelsReadUserProfile);
        }

        /// <summary>
        /// Returns true if UserModelsReadUserProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of UserModelsReadUserProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserModelsReadUserProfile input)
        {
            if (input == null)
            {
                return false;
