...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Product.Models.Read.ProductItem")]
    public partial class ProductModelsReadProductItem : IEquatable<ProductModelsReadProductItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductModelsReadProductItem" /> class.
        /// </summary>
        /// <param name="itemId">The product item id..</param>
        /// <param name="articleNumber">The article number for the product item..</param>
        /// <param name="productId">The id of the product that the item belongs to..</param>
        ...
        /// <param name="dateCreated">The date the item was created..</param>
        /// <param name="dateUpdated">The date the item was last updated..</param>
        /// <param name="active">The current state of the item..</param>
        /// <param name="externalId">External Id of the product item..</param>
        /// <param name="stock">stock.</param>
        /// <param name="shippingFees">The lowest shipping fees for each market and country for the product item..</param>
        public ProductModelsReadProductItem(int itemId = default(int), string articleNumber = default(string), int productId = default(int), string name = default(string), string shelf = default(string), int weight = default(int), int length = default(int), int width = default(int), int height = default(int), string gtin = default(string), DateTime dateCreated = default(DateTime), DateTime dateUpdated = default(DateTime), bool active = default(bool), string externalId = default(string), ProductModelsReadProductItemStock stock = default(ProductModelsReadProductItemStock), List<ProductModelsReadShippingFee> shippingFees = default(List<ProductModelsReadShippingFee>))
        {
            this.ItemId = itemId;
        ...
        /// The product item id.
        /// </summary>
        /// <value>The product item id.</value>
        ...
        /// </summary>
        /// <value>The id of the product that the item belongs to.</value>
        ...
        public ProductModelsReadProductItemStock Stock { get; set; }

        /// <summary>
        /// The lowest shipping fees for each market and country for the product item.
        /// </summary>
        /// <value>The lowest shipping fees for each market and country for the product item.</value>
        [DataMember(Name = "ShippingFees", EmitDefaultValue = false)]
        public List<ProductModelsReadShippingFee> ShippingFees { get; set; }
        ...
        {
            return this.Equals(input as ProductModelsReadProductItem);
        }

        /// <summary>
        /// Returns true if ProductModelsReadProductItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductModelsReadProductItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductModelsReadProductItem input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ShippingFees == input.ShippingFees ||
                    this.ShippingFees != null &&
                    input.ShippingFees != null &&
                    this.ShippingFees.SequenceEqual(input.ShippingFees)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ShippingFees.GetHashCode();
                }
                return hashCode;
            }
        }
