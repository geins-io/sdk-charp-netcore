...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductParameter.Models.Write.ProductParameterPredefinedValue")]
    public partial class ProductParameterModelsWriteProductParameterPredefinedValue : IEquatable<ProductParameterModelsWriteProductParameterPredefinedValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductParameterModelsWriteProductParameterPredefinedValue" /> class.
        /// </summary>
        ...
        public ProductParameterModelsWriteProductParameterPredefinedValue(int parameterId = default(int), int predefinedValueId = default(int), string name = default(string), List<SharedModelsLocalizableContent> localizedNames = default(List<SharedModelsLocalizableContent>))
        {
        ...
        {
            return this.Equals(input as ProductParameterModelsWriteProductParameterPredefinedValue);
        }

        /// <summary>
        /// Returns true if ProductParameterModelsWriteProductParameterPredefinedValue instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductParameterModelsWriteProductParameterPredefinedValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductParameterModelsWriteProductParameterPredefinedValue input)
        {
            if (input == null)
            {
                return false;
