...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Envelope-Int")]
    public partial class EnvelopeInt : IEquatable<EnvelopeInt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvelopeInt" /> class.
        /// </summary>
        ...
        public EnvelopeInt(string message = default(string), List<string> details = default(List<string>), int resource = default(int), PageResult pageResult = default(PageResult))
        {
        ...
        {
            return this.Equals(input as EnvelopeInt);
        }

        /// <summary>
        /// Returns true if EnvelopeInt instances are equal
        /// </summary>
        /// <param name="input">Instance of EnvelopeInt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvelopeInt input)
        {
            if (input == null)
            {
                return false;
