...
namespace Org.OpenAPITools.Model
{
    ...
    /// A product supplier.
    /// </summary>
    [DataContract(Name = "Supplier.Models.Write.Supplier")]
    public partial class SupplierModelsWriteSupplier : IEquatable<SupplierModelsWriteSupplier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplierModelsWriteSupplier" /> class.
        /// </summary>
        ...
        public SupplierModelsWriteSupplier(string name = default(string), string address1 = default(string), string address2 = default(string), string address3 = default(string), string zipCode = default(string), string country = default(string), string contactPerson = default(string), string phone1 = default(string), string phone2 = default(string), string email = default(string), string externalId = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as SupplierModelsWriteSupplier);
        }

        /// <summary>
        /// Returns true if SupplierModelsWriteSupplier instances are equal
        /// </summary>
        /// <param name="input">Instance of SupplierModelsWriteSupplier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupplierModelsWriteSupplier input)
        {
            if (input == null)
            {
                return false;
