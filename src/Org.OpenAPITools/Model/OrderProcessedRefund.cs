...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Order.ProcessedRefund")]
    public partial class OrderProcessedRefund : IEquatable<OrderProcessedRefund>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderProcessedRefund" /> class.
        /// </summary>
        /// <param name="refundId">refundId.</param>
        /// <param name="externalId">externalId.</param>
        /// <param name="reference">reference.</param>
        /// <param name="processedOn">processedOn.</param>
        public OrderProcessedRefund(Guid refundId = default(Guid), string externalId = default(string), string reference = default(string), DateTime processedOn = default(DateTime))
        {
        ...
        {
            return this.Equals(input as OrderProcessedRefund);
        }

        /// <summary>
        /// Returns true if OrderProcessedRefund instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderProcessedRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderProcessedRefund input)
        {
            if (input == null)
            {
                return false;
