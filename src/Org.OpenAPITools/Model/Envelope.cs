...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Envelope : IEquatable<Envelope>, IValidatableObject
    {
        ...
        public Envelope(string message = default(string), List<string> details = default(List<string>), Object resource = default(Object), PageResult pageResult = default(PageResult))
        {
        ...
        {
            return this.Equals(input as Envelope);
        }

        /// <summary>
        /// Returns true if Envelope instances are equal
        /// </summary>
        /// <param name="input">Instance of Envelope to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Envelope input)
        {
            if (input == null)
            {
                return false;
