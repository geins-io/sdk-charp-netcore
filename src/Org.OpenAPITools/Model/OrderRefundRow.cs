...
namespace Org.OpenAPITools.Model
{
    ...
    /// OrderRefundRow
    /// </summary>
    [DataContract(Name = "Order.RefundRow")]
    public partial class OrderRefundRow : IEquatable<OrderRefundRow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderRefundRow" /> class.
        /// </summary>
        ...
        public OrderRefundRow(int orderRowId = default(int), int itemId = default(int), int productId = default(int), double price = default(double), double priceExVat = default(double), string name = default(string), string productName = default(string), string variant = default(string), string brand = default(string))
        {
        ...
        {
            return this.Equals(input as OrderRefundRow);
        }

        /// <summary>
        /// Returns true if OrderRefundRow instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderRefundRow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderRefundRow input)
        {
            if (input == null)
            {
                return false;
