...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class PaymentApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test QueryPaymentOptions
        /// </summary>
        [Fact]
        public void QueryPaymentOptionsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //PaymentModelsPaymentOptionQuery query = null;
            //var response = instance.QueryPaymentOptions(query);
            //Assert.IsType<List<PaymentModelsPaymentOption>>(response);
        }
    }
}
